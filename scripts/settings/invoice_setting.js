...
async function generateTable(limit, page) {
  try {
    ...
    tableHeaderRow.innerHTML = `<th>Country</th>
             <th>Country Code</th>
    ...
    countries.forEach((country) => {
      ...
      const switchInputCell = Cell.createSwitchInputCell(
        country.enable_invoice
      );
      ...
      tableRow.appendChild(
        Cell.createSpanCell(country.short_name, false, false)
      );
      tableRow.appendChild(
        Cell.createSpanCell(country.country_code, false, false)
      );
      tableRow.appendChild(
        Cell.createSpanCell(country.full_name, false, false)
      );
      tableRow.appendChild(
