...
try {
    ...
    $service_methods = json_decode(select($conn, 'service_methods', ["id", "name"], "id", "ASC", $limit, $offset), true);
    $order_types = json_decode(select($conn, 'order_types', ["id", "name"], "id", "ASC", $limit, $offset), true);
    ...
    $response = [
        ...
        'service_methods' => $service_methods['result'],
