...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="h1 mb-3">Warehouse SKUs 
                ...
                <div id="warehouse-data-container" class="overflow-scroll"></div>
                    <div class="mb-3">
                        <div id="pagination2">
    ...
    <script type="module" src="../../scripts/settings/warehouse_skus_setting.js"></script>
</body>
</html>