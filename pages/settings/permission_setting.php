...
<body>
    ...
    <div class="container">
        <p class="h1 mb-3">Permission Settings
        ...
        <div id="permission-container" class="container"></div>
        <div class="col mb-3 d-flex justify-content-end">
            <div id="pagination2">
                <ul class="pagination m-0"></ul>
            </div>
    ...
    <script type="module" src="../../scripts/settings/permission_setting.js"></script>
</body>
