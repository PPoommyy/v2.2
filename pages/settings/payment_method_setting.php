...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <p class="h1 mb-3">Payment Methods 
                ...
                <div id="payment-data-container" class="overflow-scroll"></div>
                    <div class="mb-3">
                        <div id="pagination2">
    ...
    <script type="module" src="../../scripts/settings/payment_method_setting.js"></script>
</body>
</html>