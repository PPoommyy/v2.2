...
<body>
    ...
    <div class="row">
            ...
            <div class="col-md-6">
                <p class="h1 mb-3">Product Sets 
                    <button id="add-set-button" class="btn btn-warning">
                        <i class="fa fa-plus"></i> Add New Set
                    </button>
                    <button id="save-button" class="btn btn-warning">
                ...
                <div id="data-container" class="overflow-scroll"></div>
                <div class="mb-3">
                    <div id="pagination2">
    ...
    <script type="module" src="../../scripts/settings/product_set_setting.js"></script>
</body>
</html>