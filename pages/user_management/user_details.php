...
<body>
    ...
    <input id="orderId" type="hidden" value="<?php echo $user_id ?>">
    <div class="container">
        <p class="mb-4">
            <strong class="h1">
                User Details
            </strong>
            <small class="text-secondary"><?php echo $user_id ?></small>
        </p>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-7 row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-6"></div>
                        <button id="save-order" class="btn btn-warning"><i class="fa fa-save"></i> Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type='module' src="../../scripts/user_management/user_details.js"></script>
</body>
</html>